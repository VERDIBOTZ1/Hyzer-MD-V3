...
module.exports = {
    async handler(chatUpdate) {
        ...
        try {
            ...
            if (!isGroup && require('awesome-phonenumber')('+' + m.sender.split("@")[0]).getCountryCode() == '212') {
	        global.db.data.users[m.sender].banned = true
	        text = 'Ada User +212 Lagi Nih 🗿\nHyzer Udh Setting Biar G Ngerespon Negara +212\nSo Enjoy Aje Make Nih Sc 🙏🥶\n\n Nih Nomor Beliau Yang Kocak Geming\nwa.me/' + m.sender.split("@")[0]
